...
type AccountServiceClient interface {
	...
	GetAccountByName(ctx context.Context, in *GetAccountByNameReq, opts ...grpc.CallOption) (*GetAccountByNameRes, error)
}
...
func (c *accountServiceClient) GetAccountByName(ctx context.Context, in *GetAccountByNameReq, opts ...grpc.CallOption) (*GetAccountByNameRes, error) {
	out := new(GetAccountByNameRes)
	err := c.cc.Invoke(ctx, "/accountService.accountService/GetAccountByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	GetAccountByName(context.Context, *GetAccountByNameReq) (*GetAccountByNameRes, error)
}
...
func (UnimplementedAccountServiceServer) GetAccountByName(context.Context, *GetAccountByNameReq) (*GetAccountByNameRes, error) {
...
func _AccountService_GetAccountByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accountService.accountService/GetAccountByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).GetAccountByName(ctx, req.(*GetAccountByNameReq))
	}
	return interceptor(ctx, in, info, handler)
}
